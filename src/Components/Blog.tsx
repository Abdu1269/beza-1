...
const Blogs = () => {
  ...
  const collection: CollectionQuery = {
   ...
   const parms = useParams()
    ...
    const {data: blogs, isLoading, error}=useSWR({url:'https://saas_web.yenechinet.com/api/portal-publications/get-blogs' , params:collection }, fetcher)
...
<div className="w-fit text-neutral-950 justify-center text-center ml-40 text-8xl mb-4 font-serif grid grid-cols-1">Blogs</div>  
