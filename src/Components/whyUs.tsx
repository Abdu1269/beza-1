...
import whyUsImage from "@/public/whyus/whyus-image.jpg"; // Ensure this path matches your actual file location
...
const WhyUs = () => {
  ...
  return (
    <div className="bg-white bg-gradient-to-r from-white to-gray-100 min-h-screen py-10" title="Why Us">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-2/3 flex flex-col gap-6">
            {whyUs?.data?.map((item: WhyUsType) => (
              ...
              >
                <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900">{item.title}</h2>
                <p className="mt-4 text-base sm:text-lg text-gray-700">{item.description}</p>
              </div>
            ))}
          </div>
        </div>
